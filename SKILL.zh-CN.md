...
如果用户要求“巴菲特风格”分析，在财务核心分析完成后，加载 [references/buffett-financial-analysis.md](references/buffett-financial-analysis.md)，并用那一套业务质量视角重写结论。
...
只有在会计和报表图景已经清楚之后，才使用巴菲特风格附加层。重点不是模仿巴菲特的语气，而是用更严格的业务质量框架重新审视结论。

按以下顺序回答：

1. 公司是否真的有护城河？属于哪一种护城河？
2. 这门生意是否需要持续投入大量资本，才能维持现有盈利能力？
3. 利润是否能以可接受的一致性转化为现金？
4. 业绩在多大程度上依赖商品价格、利率、信用环境或其他外部变量？
5. 管理层是否在用能够提升每股价值的方式进行资本配置？

要明确指出一家公司可能是“好公司”，但并不一定是“符合巴菲特风格的好公司”。许多周期性、商品型、交易型或重资产负债表型企业，可能是优秀经营者，但并不是出色的长期复利机器。
...
- 在巴菲特风格模式下，要清楚区分“好公司”“好股票”和“好商业模式”
